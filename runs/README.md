...
| `2026-08-16-10v10-v3/` | Exp #3: exp2 + volume ceilings lifted (fighter window 24, reply 1400), literal laws | ratio 0.59, TWELVE llm crowns — every barn a champion; bot-12 reached rank 7 mid-run; the real ceiling identified: the model's ~5-action/day gait + crown brackets eating shallow rosters |
| `2026-08-16-10v10-v4/` | Exp #4: exp3 + bird-by-bird checklist + the hardcore truth (Majors retire losers); hosts the envoy-bug repro | honest negative result: record volume (+44% fights), ratio DOWN to 0.52 — volume without roster depth is negative-margin; exp3 stands as high-water mark; envoy bug pinned to a mechanism |
