    ...
    "enter_pintakasi",
    {
      ...
      inputSchema: z.object({
        ...
        division: z
          ...
          .optional()
          .describe(
            `Which stage. "major" (default) = the hardcore Majors, age ${AGE.FORK}+, ${PINTAKASI.QUALIFYING_POINTS} qualification points. "juvenile" = the Juvenile Championship the day before, age ${AGE.CHICK} only, ${JUVENILE_MAJOR.QUALIFYING_WINS} juvenile wins, NOT hardcore`
          ),
      }),
    },
