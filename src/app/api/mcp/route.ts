...
// number a player asks about — "does this finish get my 80 GP back?" is. The
...
const breakEven = (share: number) =>
  share > 0 && majorFee > 0 ? Math.ceil(majorFee / share).toLocaleString() : "0";
const majorOneWinBreakEven = breakEven(purseShareOf(majorBracket, PINTAKASI.PURSE, 1, "none"));
const majorChampionBreakEven = breakEven(
  purseShareOf(majorBracket, PINTAKASI.PURSE, Math.log2(majorBracket), "champion")
);
