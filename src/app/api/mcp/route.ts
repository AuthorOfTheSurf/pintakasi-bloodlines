...
export const MCP_INSTRUCTIONS: string[] = [
  ...
  "WEAPON FORMATS ARE THE DISTANCE DIAL — the player's core skill is picking the right one: b1 (the sprint — agility/sight decide it), b2 (the hybrid), b3 (the route — stamina starts to rule), b4 (the marathon — gameness dictates the deep rounds). Any bird can enter any format; it's just disadvantaged outside its type.",
