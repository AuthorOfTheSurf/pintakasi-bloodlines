...
export const MCP_INSTRUCTIONS: string[] = [
  ...
  "WEAPON FORMATS ARE THE DISTANCE DIAL, enumerated B1–B4 from sprint to marathon (round 26 — more blade lengths are coming, and the middle of the dial is where a flat-built bird will shine): B1 (the sprint — agility/sight decide it, the old long knife), B2 (the hybrid), B3 (the route — stamina starts to rule), B4 (the marathon — gameness dictates the deep rounds). Any bird can enter any format; it's just disadvantaged outside its type.",
