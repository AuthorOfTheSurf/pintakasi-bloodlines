...
export const BOT_FARMS: BotProfile[] = [
  ...
  // ── The broodfarms: breed for the top, sell the surplus ─────────────────
  {
    ...
    flockSeed: 303,
    entryRate: 0.5,
    claimAggression: 0.05,
    breedDrive: 0.9,
    hardcoreNerve: 0.02,
    sellRate: 0.5,
    tagCourage: 0.4,
    ladderCourage: 0.08,
    housePair: 2, // deep-water blood
    gachaHabit: 0.3, // covers first — the gacha is a sideline
  },
  {
    id: "scripted-4",
    name: "Dugo't Dangal Farms",
    country: "🇵🇭",
    primaryColor: "red",
    secondaryColor: "white",
    style: "breeder",
  ...
  },
  {
    ...
    tagCourage: 0.6,
    ladderCourage: 0.45,
    housePair: 0, // "lightning" — breeds the break
    gachaHabit: 0.75,
  },
  ...
  //    Deeper population = fuller lobbies, fuller brackets, more claims.
  {
    ...
    tagCourage: 0.45,
    ladderCourage: 0.55,
    housePair: 2, // the nerviest barn in the game
    gachaHabit: 0.8,
  },
  {
    id: "bot-5",
    name: "Cuchillos de Sonora",
    country: "🇲🇽",
    primaryColor: "green",
    secondaryColor: "red",
    style: "claimer",
    ...
    tagCourage: 0.7,
    ladderCourage: 0.2,
    housePair: 0, // knife barn — shops the dear end of the tag ladder
    gachaHabit: 0.6,
  },
  {
    id: "bot-4",
    name: "Cavite Bloodlines",
    country: "🇵🇭",
    primaryColor: "brown",
    secondaryColor: "gold",
    style: "breeder",
    ...
    tagCourage: 0.2,
    ladderCourage: 0.1,
    housePair: 1, // breeds first, fights second
    gachaHabit: 0.25,
  },
  // ── Round 23: the two speculators ───────────────────────────────────────
  {
    id: "scripted-7",
    name: "Ginto Gaming Club",
    country: "🇵🇭",
    handler: "Ginto",
    primaryColor: "gold",
    secondaryColor: "black",
